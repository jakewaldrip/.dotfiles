...
-- Toggle Minimap
vim.keymap.set('n', '<leader>nm', ':MinimapToggle<CR>', { desc = 'Toggle Minimap' })
...
require('lazy').setup({
  ...
  -- Improved typescript language server
  {
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- For more mini plugins, check out: https://github.com/echasnovski/mini.nvim
    end,
  },
